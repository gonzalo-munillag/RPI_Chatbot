#!/bin/bash
# =============================================================================
# Train "Hey Prometheus" Wake Word - Sample Collection Script
# =============================================================================
#
# This script helps you record audio samples on your Raspberry Pi to train
# a custom "Hey Prometheus" wake word model.
#
# Usage:
#   chmod +x train_hey_prometheus.sh
#   ./train_hey_prometheus.sh
#
# =============================================================================
...
# Output directories
BASE_DIR="$HOME/prometheus_training"
...
print_header "📋 Next Steps: Train the Model"

echo "Option A: Train on Pi (requires Python packages)"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
echo "  # Install training dependencies"
echo "  pip install openwakeword"
echo ""
echo "  # Run training (may take 10-30 minutes)"
echo "  python3 << 'EOF'"
echo "from openwakeword.utils import train_custom_model"
echo ""
echo "train_custom_model("
echo "    positive_dir='$POSITIVE_DIR',"
echo "    negative_dir='$NEGATIVE_DIR',"
echo "    output_path='$MODEL_DIR/hey_prometheus.onnx',"
echo "    model_name='hey_prometheus'"
echo ")"
echo "EOF"
echo ""
echo ""
echo "Option B: Train on a faster computer"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
echo "  # Copy samples to your computer"
echo "  scp -r pi@<PI_IP>:$BASE_DIR ./prometheus_training"
echo ""
echo "  # Train there, then copy model back"
echo "  scp ./prometheus_training/models/hey_prometheus.onnx pi@<PI_IP>:$MODEL_DIR/"
echo ""
echo ""
echo "Option C: Use pre-trained model for now"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
echo "  # Use 'Hey Jarvis' until custom model is ready"
echo "  # Edit /var/www/ollama_chatbot/.env:"
echo "  WAKE_WORD_MODEL=hey_jarvis"
echo ""
echo ""

print_header "🚀 After Training: Deploy the Model"

echo "1. Copy model to the wakeword container:"
echo "   sudo cp $MODEL_DIR/hey_prometheus.onnx \\"
echo "        /var/lib/docker/volumes/ollama_chatbot_wakeword-models/_data/"
echo ""
echo "2. Update .env:"
echo "   WAKE_WORD_MODEL=/app/models/hey_prometheus.onnx"
echo ""
echo "3. Restart the service:"
echo "   cd /var/www/ollama_chatbot"
echo "   sudo docker-compose up -d wakeword"
echo ""
echo "4. Start listening:"
echo "   curl -X POST http://localhost:5003/start"
echo ""
echo "5. Say 'Hey Prometheus' and enjoy! 🎉"
echo ""
